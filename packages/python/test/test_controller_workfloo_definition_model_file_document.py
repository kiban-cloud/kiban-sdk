...
class TestControllerWorkflooDefinitionModelFileDocument(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ControllerWorkflooDefinitionModelFileDocument:
        """Test ControllerWorkflooDefinitionModelFileDocument
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ControllerWorkflooDefinitionModelFileDocument`
        """
    ...
    def testControllerWorkflooDefinitionModelFileDocument(self):
        """Test ControllerWorkflooDefinitionModelFileDocument"""
