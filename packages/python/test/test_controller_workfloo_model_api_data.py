...
class TestControllerWorkflooModelApiData(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ControllerWorkflooModelApiData:
        """Test ControllerWorkflooModelApiData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ControllerWorkflooModelApiData`
        """
    ...
    def testControllerWorkflooModelApiData(self):
        """Test ControllerWorkflooModelApiData"""
