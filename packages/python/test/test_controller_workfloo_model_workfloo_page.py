...
class TestControllerWorkflooModelWorkflooPage(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ControllerWorkflooModelWorkflooPage:
        """Test ControllerWorkflooModelWorkflooPage
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ControllerWorkflooModelWorkflooPage`
        """
        model = ControllerWorkflooModelWorkflooPage()
        if include_optional:
    ...
    def testControllerWorkflooModelWorkflooPage(self):
        """Test ControllerWorkflooModelWorkflooPage"""
