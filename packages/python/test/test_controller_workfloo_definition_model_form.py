...
class TestControllerWorkflooDefinitionModelForm(unittest.TestCase):
    """ControllerWorkflooDefinitionModelForm unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ControllerWorkflooDefinitionModelForm:
        """Test ControllerWorkflooDefinitionModelForm
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ControllerWorkflooDefinitionModelForm`
        """
        model = ControllerWorkflooDefinitionModelForm()
        if include_optional:
            return ControllerWorkflooDefinitionModelForm(
                form_field_section = [
    ...
    def testControllerWorkflooDefinitionModelForm(self):
        """Test ControllerWorkflooDefinitionModelForm"""
