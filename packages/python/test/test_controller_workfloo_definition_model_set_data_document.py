...
class TestControllerWorkflooDefinitionModelSetDataDocument(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ControllerWorkflooDefinitionModelSetDataDocument:
        """Test ControllerWorkflooDefinitionModelSetDataDocument
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ControllerWorkflooDefinitionModelSetDataDocument`
        """
        model = ControllerWorkflooDefinitionModelSetDataDocument()
        if include_optional:
    ...
    def testControllerWorkflooDefinitionModelSetDataDocument(self):
        """Test ControllerWorkflooDefinitionModelSetDataDocument"""
