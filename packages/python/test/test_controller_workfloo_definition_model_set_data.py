...
class TestControllerWorkflooDefinitionModelSetData(unittest.TestCase):
    """ControllerWorkflooDefinitionModelSetData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ControllerWorkflooDefinitionModelSetData:
        """Test ControllerWorkflooDefinitionModelSetData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ControllerWorkflooDefinitionModelSetData`
        """
        model = ControllerWorkflooDefinitionModelSetData()
        if include_optional:
            return ControllerWorkflooDefinitionModelSetData(
                fields = [
    ...
    def testControllerWorkflooDefinitionModelSetData(self):
        """Test ControllerWorkflooDefinitionModelSetData"""
