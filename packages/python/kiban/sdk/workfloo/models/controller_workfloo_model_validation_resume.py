...
class ControllerWorkflooModelValidationResume(BaseModel):
    """
    ControllerWorkflooModelValidationResume
    """ # noqa: E501
    decision: Optional[StrictStr] = None
    reviewed_at: Optional[StrictStr] = Field(default=None, alias="reviewedAt")
    ...
    reviews: Optional[List[ControllerWorkflooModelReviewResume]] = None
    __properties: ClassVar[List[str]] = ["decision", "reviewedAt", "reviewedBy", "reviewerNote", "reviews"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "reviews": [ControllerWorkflooModelReviewResume.from_dict(_item) for _item in obj["reviews"]] if obj.get("reviews") is not None else None
        })
        return _obj
