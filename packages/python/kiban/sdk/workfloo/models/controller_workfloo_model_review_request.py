...
class ControllerWorkflooModelReviewRequest(BaseModel):
    """
    ...
    reviews: Optional[List[ControllerWorkflooModelReviewFieldRequest]] = None
    __properties: ClassVar[List[str]] = ["decision", "reviewerNote", "reviews"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "reviews": [ControllerWorkflooModelReviewFieldRequest.from_dict(_item) for _item in obj["reviews"]] if obj.get("reviews") is not None else None
        })
        return _obj
