...
conf = kiban.sdk.workfloo.Configuration(
    ...
    def __init__(
        ...
        *,
        ...
        """Constructor
        """
        self._base_path = "https://workfloo.kiban.com" if host is None else host
        """Default Base url
        """
        ...
        """Logging Settings
        """
        self.logger["package_logger"] = logging.getLogger("kiban.sdk.workfloo")
    ...
    def get_host_settings(self) -> List[HostSetting]:
        ...
        return [
            {
                'url': "https://workfloo.kiban.com",
                'description': "Producción",
            },
            {
                'url': "https://sandbox.workfloo.kiban.com",
                'description': "Sandbox. Activa el modo sandbox implícitamente; el query param sandbox se ignora en este host.",
            }
        ]
