...
from kiban.sdk.workfloo.configuration import Configuration
from kiban.sdk.workfloo.api_response import ApiResponse, T as ApiResponseT
import kiban.sdk.workfloo.models
from kiban.sdk.workfloo import rest
from kiban.sdk.workfloo.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(kiban.sdk.workfloo.models, klass)
